(function () {
  ...
  */
  ...
  function ai$1(a){for(;;){var b=a.alternate,c=a.return,d=a.sibling;if(0===(a.effectTag&1024)){T=a;a:{var e=b;b=a;var f=U;var g=b.pendingProps;switch(b.tag){case 2:break;case 16:break;case 15:case 0:break;case 1:J(b.type)&&Ke();break;case 3:Kf();Le();g=b.stateNode;g.pendingContext&&(g.context=g.pendingContext,g.pendingContext=null);if(null===e||null===e.child)Eg(b),b.effectTag&=-3;mh(b);break;case 5:Mf(b);var h=If(Hf.current);f=b.type;if(null!==e&&null!=b.stateNode)nh(e,b,f,g,h),e.ref!==b.ref&&(b.effectTag|=
  ...
  function bi(a){var b=Tg(a.alternate,a,U);a.memoizedProps=a.pendingProps;null===b&&(b=ai$1(a));Ih.current=null;return b}
  ...
  ***************************************************************************** */
  ...
  var MOVING = 'MOVING';
  var IN_PLACE_TO_ATTACK = 'IN_PLACE_TO_ATTACK';
  var OWNER_COMPONENT = 'OWNER';
  var SPRITE = 'SPRITE';
  var UI_COMP = 'UI';
  var PLAYER_CONTROLLED = 'PLAYER_CONTROLLED';
  var POSITION = 'POSITION';
  var MOVEMENT_COMP = 'MOVE';
  var HAS_FIGHTERS = 'HAS_FIGHTERS';
  var DEFENDING = 'DEFENDING';
  var CAN_ATTACK_PLANETS = 'CAN_ATTACK_PLANETS';
  ...
  var PLANETS = 'planets';
  var CIRCLE = 'circle';
  var FIGHTER_COUNT = 'FIGHTER_COUNT';
  var FIGHTER_IMAGE = 'FIGHTER_IMAGE';
  var SHIELD_IMAGE = 'SHIELD_IMAGE';
  var CLICK = 'click';
  ...
  var MEDIUM = '2';
  var LARGE = '4';
  var FIGHTER_BUILD_RATE = 'FIGHTER_BUILD_RATE';
  var FIGHTER_RADIUS = 'FIGHTER_RADIUS';
  var FIGHTER_SPEED = 'FIGHTER_SPEED';
  var AI_MIN_FIGHTERS = 'AI_MIN_FIGHTERS';
  var DEFAULT_FIGHTER_COUNT = 'DEFAULT_FIGHTER_COUNT';
  var EASY = 'EASY';
  var CHALLENGING = 'CHALLENGING';
  var HARD = 'HARD';
  var DIFFICULTY = 'DIFFICULTY';
  var AI_DECISION_RATE = 'AI_DECISION_RATE';
  var MAIN_VIEW_SIZE_X = 'MAIN_VIEW_SIZE_X';
  var MAIN_VIEW_SIZE_Y = 'MAIN_VIEW_SIZE_Y';
  var PLAYER_PLANET_GUTTER_DISTANCE = 'PLAYER_PLANET_GUTTER_DISTANCE';
  var SELECT_WIDTH = 'SELECT_WIDTH';
  var STRESS_TEST = 'STRESS_TEST';
  var EXPLOSION = 'EXPLOSION';
  var EVENTS = {
      APP_LOADING: 'APP_LOADING',
      APP_LOADED: 'APP_LOADED',
      LEVEL_STARTED: 'LEVEL_INTERACTIONS',
  ...
  var PositionComponent = /** @class */ (function () {
      function PositionComponent(x, y, radius) {
          this.name = POSITION;
          this.x = x;
          this.y = y;
          this.radius = radius;
  ...
  function setDest(ent, target) {
      ...
      // Set movement angle
      var deltaY = ent[POSITION].destY - ent[POSITION].y;
      var deltaX = ent[POSITION].destX - ent[POSITION].x;
  ...
  var OwnerComponent = /** @class */ (function () {
      function OwnerComponent(player) {
          if (player === void 0) { player = NEUTRAL; }
  ...
  ***************************************************************************** */
  ...
  unwrapExports(build);
  build.Engine;
  var build_2 = build.Entity;
  var build_3 = build.GameCanvas;
  var build_4 = build.ObjectPool;
  var build_5 = build.entityLoop;

  // REFACTOR to just "fighters" component
  var HasFighters = /** @class */ (function () {
  ...
  function stopDefending(fighter) {
      ...
      build_2.entities[fighter.planetID][HAS_FIGHTERS].defenders--;
  ...
  function detachFighterFromPlanet(fighter) {
      ...
      var currentFighters = getFighters(build_2.entities[fighter.planetID]).concat();
      currentFighters.splice(currentFighters.indexOf(fighter), 1);
      // @ts-ignore fix with a Generic Entity.
      build_2.entities[fighter.planetID][HAS_FIGHTERS].fighters = currentFighters;
   ...
   * @return {*}
   */
  function addFighter(planet, fighter) {
  ...
  function destroyFighter(fighter) {
      var ownerPlanet = build_2.entities[fighter.planetID];
   ...
   * @param fighter
   */
  function reassignFighter(newPlanet, fighter) {
      var ownerPlanet = build_2.entities[fighter.planetID];
      // if fighter has an owner..
      if (ownerPlanet) {
          // if fighter was defending, remove it from defender count
  ...
  var gameConfig = (_a$1 = {},
      _a$1[SELECT_WIDTH] = 3,
      _a$1[PLANET_RADIUS] = 40,
      _a$1[FIGHTER_RADIUS] = 10,
      _a$1[NUM_PLAYERS] = 2,
      _a$1[AI_MIN_FIGHTERS] = 5,
      _a$1[DEFAULT_FIGHTER_COUNT] = 10,
      _a$1[FIGHTER_BUILD_RATE] = 60,
      _a$1[FIGHTER_SPEED] = 2,
      _a$1[COLORS] = (_b$1 = {},
          _b$1[NEUTRAL] = 'rgba(128, 128, 128, 1)',
          _b$1[PLAYER_1] = 'rgba(0, 255, 0, 1)',
          _b$1[PLAYER_2] = 'rgba(255, 0, 0, 1)',
          _b$1[PLAYER_3] = 'rgba(0, 0, 255, 1)',
          _b$1[DEFAULT] = 'black',
          _b$1),
      _a$1[DIFFICULTY] = (_c$1 = {},
          _c$1[EASY] = (_d$1 = {},
              _d$1[AI_DECISION_RATE] = 120,
              _d$1),
          _c$1[CHALLENGING] = (_e = {},
              _e[AI_DECISION_RATE] = 100,
              _e),
          _c$1[HARD] = (_f = {},
              _f[AI_DECISION_RATE] = 80,
              _f),
          _c$1[STRESS_TEST] = (_g = {},
              _g[AI_DECISION_RATE] = 10,
              _g),
          _c$1),
      _a$1[PLAYER_PLANET_GUTTER_DISTANCE] = 50,
      _a$1[MAIN_VIEW_SIZE_X] = 1920 / 2,
      _a$1[MAIN_VIEW_SIZE_Y] = 1080 / 2,
      _a$1);
   ...
   */
  var GameTracker = /** @class */ (function () {
      function GameTracker() {
          this.actions = {};
      }
      GameTracker.prototype.track = function (action) {
      ...
      GameTracker.prototype.reset = function () {
          this.actions = {};
      };
      GameTracker.prototype.getReport = function () {
          return this.actions;
      };
      return GameTracker;
  }());
  ...
  var fighterPool;
  var fighterImage$1 = new Image();
  fighterImage$1.src = fighter;
  function createFighterEntity(planet, createdDuringPlay) {
      if (createdDuringPlay === void 0) { createdDuringPlay = true; }
  ...
  var FighterEntity = /** @class */ (function (_super) {
      __extends(FighterEntity, _super);
      function FighterEntity() {
          var _this = _super.call(this) || this;
          _this.addComponent(new MoveComponent(gameConfig[FIGHTER_SPEED]));
          _this.addComponent({ name: CAN_ATTACK_PLANETS });
          _this.addComponent(new Defending);
          _this.addComponent(new Sprite([{
                  name: FIGHTER_IMAGE // default
              }
          ]));
          _this.addComponent(new OwnerComponent(null));
          _this.addComponent(new PositionComponent(null, null, gameConfig[FIGHTER_RADIUS]));
          return _this;
      }
      FighterEntity.prototype.remove = function () {
      ...
      FighterEntity.prototype.reset = function () {
          // Remove the 'in place to attack';
  ...
  function setFighterAsFleet(fighter, fleetCount) {
      if (!fighter) {
          return null;
      }
      var images = [];
      var deltaFormationSpan = 0.75;
      var deltaFormationDistance = 0;
      for (var i = 0; i < Math.min(fleetCount, 5); i++) {
          var spanMultiplier = void 0;
          if (i === 0) {
              spanMultiplier = 0;
          }
          else {
          ...
          var calcAngle = fighter[POSITION].angle - spanMultiplier * deltaFormationSpan;
          var distance = fighter[POSITION].radius * 2 * deltaFormationDistance;
          images.push({
              name: FIGHTER_IMAGE,
              pos: {
  ...
  fighterPool = new build_4(FighterEntity);
  ...
  function getSelectedEntities() {
      var entities = build_2.getByComps([PLAYER_CONTROLLED]);
      return build_5(entities, function (ent) {
  ...
  function getEntitiesAtPos(x, y) {
      var entities = build_2.getByComps([POSITION]);
      return build_5(entities, function (ent) {
          var centerX = ent[POSITION].x;
          var centerY = ent[POSITION].y;
          var radius = ent[POSITION].radius;
          if (isPosInsideCircle(x, y, centerX, centerY, radius)) {
              return true;
          }
      });
  }
  function selectEntity(_a) {
      var x = _a.x, y = _a.y;
      var entities = build_2.getByComps([POSITION, PLAYER_CONTROLLED, OWNER_COMPONENT]);
      build_5(entities, function (ent) {
          var centerX = ent[POSITION].x;
          var centerY = ent[POSITION].y;
          var radius = ent[POSITION].radius;
          // this is what stops us from selecting an entity that does not belong to us
          var ownedByPlayer = getOwner(ent) === PLAYER_1;
  ...
  function getEntitiesInSelectedBox(selectedBox) {
      var entities = build_2.getByComps([POSITION, HAS_FIGHTERS, OWNER_COMPONENT, PLAYER_CONTROLLED]);
   ...
   * @returns {Null}
   */
  function selectAllEntities(playerKey) {
      var entities = build_2.getByComps([PLAYER_CONTROLLED, OWNER_COMPONENT]);
      build_5(entities, function (ent) {
   ...
   */
  function attack(action, entities) {
      if (entities === void 0) { entities = getSelectedEntities(); }
      ...
      var targetPlanet = getEntitiesAtPos(action.x, action.y).filter(function (ent) {
      ...
      attackingPlanets.forEach(function (attackingPlanet) {
          fightersInFleet = [];
          getFighters(attackingPlanet).forEach(function (fighterEnt) {
          ...
          var firstFighter = fightersInFleet[0];
  ...
  function userInputSystem(systemArguments) {
      ...
      actions.forEach(function (action) {
          ...
          if (action.entities) {
              build_5(action.entities, function (ent) {
                  // do stuff here on multiple entities, not really used..
              });
          }
          else {
              if (action.name === CLICK) {
                  var clickedEntities = action.hits.map(function (hit) {
                      if (build_2.entities[hit.id]) {
                          return build_2.entities[hit.id];
                      }
                      else {
                          return false;
                      }
  ...
  var InPlaceToAttack = /** @class */ (function () {
      function InPlaceToAttack() {
          this.name = IN_PLACE_TO_ATTACK;
      }
      return InPlaceToAttack;
  }());
  ...
  function moveEntity(entity) {
      ...
      var destX = getDest(entity).x;
      var destY = getDest(entity).y;
      /* istanbul ignore next */
      if (destX && destY) {
          var curX = getPos(entity).x;
          var curY = getPos(entity).y;
  ...
  function moveSystem(systemArguments) {
      var entities = build_2.getByComps([MOVEMENT_COMP, POSITION, MOVING]);
      if (entities.length) {
          build_5(entities, function (entity) {
              moveEntity(entity);
          });
      }
  }
  ...
  function fighterAttacks(systemArguments) {
      var hits = build_2.getByComps([OWNER_COMPONENT, CAN_ATTACK_PLANETS, IN_PLACE_TO_ATTACK]);
      var planets = build_2.getByComps([HAS_FIGHTERS], 'array');
      hits.forEach(function (attacker) {
          ...
          if (friendlyPlanet) {
              ...
              if (getDefendingFighters(foundPlanet) === 0) {
                  ...
                  var arr = Object.assign([], getFighters(foundPlanet));
              ...
              var defender = getFighters(foundPlanet).find(function (defFighter) {
  ...
  function buildFighters(systemArguments) {
      ...
      var entities = build_2.getByComps([OWNER_COMPONENT, HAS_FIGHTERS]);
      build_5(entities, buildFighterLoop);
  }
  ...
  var EarthLike = /** @class */ (function (_super) {
      __extends(EarthLike, _super);
      function EarthLike(xPos, yPos, player) {
          if (xPos === void 0) { xPos = 50; }
          if (yPos === void 0) { yPos = 50; }
          if (player === void 0) { player = NEUTRAL; }
          var _this = _super.call(this) || this;
          // let ent = new BaseEntity(EarthLike);
          var planetRadius = gameConfig[PLANET_RADIUS];
          _this.addComponent(new PositionComponent(xPos, yPos, planetRadius));
          _this.addComponent(new PlayerControlledComponent());
          _this.addComponent(new OwnerComponent(player));
          _this.addComponent(new HasFighters());
          _this.addComponent(new Attackable(true));
          _this.addComponent(new Sprite([
              {
                  name: PLANETS
              },
          ...
          _this.addComponent(new UIComponent(shapes));
          return _this;
      }
      return EarthLike;
  }(BaseEntity));
  ...
  var Logger = /** @class */ (function () {
      function Logger() {
          ...
          this.error = console.log.bind(console, '%c %s', 'color:red;font-weight:bold'); // eslint-disable-line
          this.info = console.log.bind(console, '%c %s', 'color:teal'); // eslint-disable-line
      }
      return Logger;
  }());
  ...
  function canCircleBePlacedInPos(x, y, radius, grid) {
      var blocks = getBlocksFromPos(x, y, radius, grid);
      if (blocks) {
          var startGridBlock = blocks.startGridBlock, endGridBlock = blocks.endGridBlock;
  ...
  function placeEntityInGrid(ent, targetX, targetY, radius, grid) {
      var blocksFromPosition = getBlocksFromPos(targetX, targetY, radius, grid);
      if (blocksFromPosition) {
          var startGridBlock = blocksFromPosition.startGridBlock, endGridBlock = blocksFromPosition.endGridBlock;
          var blocks = getBlocks(startGridBlock, endGridBlock, grid);
          blocks.forEach(function (block) {
              block.occupied = true;
          });
  ...
  function entityPlacer(entities, grid, buffer) {
      ...
      var entsWithPos = build_5(entities, function (ent) {
      ...
      entsWithPos.forEach(function (ent) {
          ...
          var _a = ent[POSITION], x = _a.x, y = _a.y, radius = _a.radius;
      ...
      var placedEntities = build_5(entities, function (ent) {
          ...
          while (pos.x === null) {
              ...
              var x = randFromRange(xMin, xMax);
              var y = randFromRange(yMin, yMax);
  ...
  function createGrid(area, squaresInLine) {
      var topLeftAreaX = area.topLeftAreaX, topLeftAreaY = area.topLeftAreaY, bottomRightAreaX = area.bottomRightAreaX, bottomRightAreaY = area.bottomRightAreaY;
      var grid = [];
  ...
  function placeEntities(entities, area, buffer) {
      var topLeftAreaX = area.topLeftAreaX; area.topLeftAreaY; var bottomRightAreaX = area.bottomRightAreaX; area.bottomRightAreaY;
  ...
  function validateLevelData(levelData) {
      try {
          var hasWidth = levelData.width > 0;
          var hasHeight = levelData.height > 0;
          var hasBuffer = levelData.buffer > 0;
          var hasPlanetsInMap = levelData.planetsInMap || levelData.planets;
  ...
  function generateMap(levelData) {
      ...
      var buffer = levelData.buffer;
      var planetsToGenerate; // by default, we don't need to generate anything
      ...
      var planets = {};
      if (levelData.planets) {
          levelData.planets.forEach(function (planetData) {
              var planet = new EarthLike(planetData.position.x, planetData.position.y, planetData.player);
          ...
          while (count < planetsToGenerate) {
              var planet = new EarthLike(null, null, NEUTRAL);
              planets[planet.id] = planet;
      ...
      if (levelData.planets) ;
          ...
          var gutter = gameConfig[PLAYER_PLANET_GUTTER_DISTANCE];
          var p1 = new EarthLike(gutter, gutter, PLAYER_1);
          // *2 to adjust for the menu button location.. silly but it works :)
          var p2 = new EarthLike(levelData.width - gutter * 2, levelData.height - gutter * 2, PLAYER_2);
          planets[p1.id] = p1;
          planets[p2.id] = p2;
      }
  ...
  function loadImages(imagePaths, callback) {
      ...
      return imagesToLoad.map(function (imagePath) {
          var img = new Image();
          img.onload = function () {
              imagesLoaded++;
              renderOnReady();
  ...
  function aiAttack(attacker) {
      var entities = build_2.getByComps([OWNER_COMPONENT, HAS_FIGHTERS]);
      var defenders = build_5(entities, function (ent) {
          return getOwner(ent) === PLAYER_1;
      });
      var defenderPos = getPos(randFromArray(defenders));
      attack(defenderPos, [attacker]); // redirect false, do not change dest of fighters
  }
  function aiExpand(expander) {
      var entities = build_2.getByComps([OWNER_COMPONENT, HAS_FIGHTERS]);
      var neutrals = build_5(entities, function (ent) {
  ...
  function ai(systemArguments) {
      ...
      var decisionMakers = build_5(entities, function (ent) {
  ...
  function calcWinner() {
      var entities = build_2.getByComps([ATTACKABLE, OWNER_COMPONENT]);
      var enemyEntitiesLeft = 0;
      var playerEntsLeft = 0;
      build_5(entities, function (ent) {
          var owner = ent[OWNER_COMPONENT].player;
          var friendlies = [PLAYER_1, NEUTRAL];
  ...
  var GameState = /** @class */ (function () {
      function GameState(val, numPlayers) {
          if (val === void 0) { val = IN_PROGRESS; }
  ...
  var CurrentGame = /** @class */ (function () {
      function CurrentGame(numPlayers) {
          var ent = new BaseEntity(CurrentGame);
          ent.name = GAME;
  ...
  var GameLoop = /** @class */ (function () {
      function GameLoop(_a) {
          var _this = this;
          var notificationSystem = _a.notificationSystem, renderSystem = _a.renderSystem, levelData = _a.levelData, viewSize = _a.viewSize, difficulty = _a.difficulty, numPlayers = _a.numPlayers;
          gameTracker.track('newGameStarted');
          build_2.reset();
          fighterPool.generate(10000); // for performance reasons
          generateMap(levelData);
          var currentGame = new CurrentGame(numPlayers);
          var count = 0;
          var systemArguments = {
              levelData: levelData,
              viewSize: viewSize,
          ...
          this.loop = function () {
              ...
              if (currentGame[GAME_STATE]) {
                  ...
                  currentGame[GAME_STATE].frameID = requestAnimationFrame(_this.loop);
  ...
  var Modal = /** @class */ (function (_super) {
      ...
      Modal.prototype.render = function () {
          var cls = "endGame " + (this.props.gameWon ? 'gameWon' : 'gameLost');
          return (react.createElement("div", { className: cls },
              react.createElement("div", { className: "content bordered" },
                  react.createElement("div", { className: "stats pull-left" },
                      react.createElement("span", { className: "title" }, this.props.text),
                      this.props.children),
                  react.createElement("div", { className: "btnList pull-right" },
                      this.props.nextLevel &&
                          react.createElement("button", { onClick: this.props.onNextLevel, className: "btnItem nextLevel" }, i18n.nextLevel),
                      react.createElement("button", { onClick: this.props.onRestart, className: "btnItem restart" }, i18n.restart),
                      react.createElement("button", { onClick: this.props.backToMainMenu, className: "btnItem mainMenu" }, i18n.mainMenu)))));
      };
      return Modal;
  }(react.Component));

  var player1 = "./player1.png";

  var player2 = "./player2.png";
  ...
  var Help = /** @class */ (function (_super) {
      ...
      Help.prototype.renderHelp = function () {
          return (react.createElement("div", { className: "helpSection" },
              react.createElement("div", null, "General help:"),
              react.createElement("ul", null,
                  react.createElement("li", null,
                      "Tap one of your planets ",
                      react.createElement("img", { className: "inlineImage", src: player1 }),
                      " to select."),
                  react.createElement("li", null,
                      "Tap enemy planet ",
                      react.createElement("img", { className: "inlineImage", src: player2 }),
                      " to attack."),
                  react.createElement("li", null, "Double tap on one of your planets to selects all."))));
      };
      Help.prototype.renderLevelHelp = function () {
          if (this.props.levelHints) {
              return (react.createElement("div", null,
                  react.createElement("div", null, "Level hints:"),
                  react.createElement("ul", null, this.props.levelHints.map(function (item, i) {
                      return (react.createElement("li", { className: "hint", key: i }, item));
                  }))));
          }
          else {
              return null;
      ...
      Help.prototype.render = function () {
          return (react.createElement("div", { className: "showHelp centered md bordered" },
              react.createElement("div", { className: "menuHeader" }, i18n.gamePaused),
              this.renderHelp(),
              this.renderLevelHelp(),
              react.createElement("button", { className: "btnItem", onClick: this.props.onClick }, i18n.resumeGame)));
      };
      return Help;
  }(react.Component));
  ...
  var LocalStorage = /** @class */ (function () {
      ...
      LocalStorage.prototype.removeItem = function () {
          var args = [];
          for (var _i = 0; _i < arguments.length; _i++) {
              args[_i] = arguments[_i];
          }
      ...
      LocalStorage.prototype.setJSON = function (key, obj) {
          try {
      ...
      LocalStorage.prototype.getJSON = function (args) {
          try {
  ...
  var PlayerService = /** @class */ (function () {
      ...
      PlayerService.prototype.persistState = function () {
      ...
      PlayerService.prototype.getPlayer = function (userName) {
          return this.data.players.find(function (player) {
              return player.userName === userName;
          });
      };
      PlayerService.prototype.getRegisteredPlayers = function () {
          return this.data.players;
      };
      PlayerService.prototype.createPlayer = function (userName) {
      ...
      PlayerService.prototype.finishLevel = function (levelKey) {
      ...
      PlayerService.prototype.deletePlayer = function (userName) {
          if (this.data.selectedPlayer && this.data.selectedPlayer.userName === userName) {
              this.data.selectedPlayer = null;
          }
          this.data.players = this.data.players.filter(function (player) {
              return player.userName !== userName;
          });
          this.persistState();
      };
      PlayerService.prototype.getSelectedPlayer = function () {
          return this.data.selectedPlayer;
      };
      PlayerService.prototype.selectPlayer = function (userName) {
      ...
      PlayerService.prototype.validateUsername = function (userName) {
          var isAvailable = !this.getPlayer(userName);
          var isLongEnough = userName && userName.length > 3;
  ...
  var createNewPlayer = /** @class */ (function (_super) {
      __extends(createNewPlayer, _super);
      function createNewPlayer(props) {
      ...
      createNewPlayer.prototype.submitForm = function () {
          var isInputValid = playerService.validateUsername(this.state.inputValue);
          if (isInputValid) {
              this.props.onSubmit(this.state.inputValue);
          }
      };
      createNewPlayer.prototype.render = function () {
          var _this = this;
          var isInputValid = playerService.validateUsername(this.state.inputValue);
          return (react.createElement("div", { className: "createNewPlayer centered md" },
              react.createElement("div", { className: "menuHeader" }, playerService.getRegisteredPlayers().length ? i18n.createNewPlayer : i18n.createPlayerIntro),
              react.createElement("div", { className: "" },
                  react.createElement("div", { className: "inputSection" },
                      react.createElement("input", { className: "btnItem playerUserName", type: "text", placeholder: i18n.enterUsername, onChange: function (event) {
                      ...
                      react.createElement("div", { className: isInputValid ? 'lenHelper' : 'tooShort lenHelper' }, i18n.aFewMoreLetters)),
                  react.createElement("div", { className: "createPLayerSection" },
                      react.createElement("button", { className: "btnItem createPLayerBtn", onClick: this.submitForm }, i18n.create)))));
      };
      return createNewPlayer;
  }(react.Component));

  var GlobalTracker = /** @class */ (function () {
      function GlobalTracker() {
          this.subs = [];
      }
      GlobalTracker.prototype.dispatch = function (name, payload) {
          this.subs.forEach(function (fn) {
              fn(name, payload);
          });
      };
      GlobalTracker.prototype.subscribe = function (fn) {
          var _this = this;
          this.subs.push(fn);
          return function () {
              _this.subs.splice(_this.subs.indexOf(fn), 1);
          };
      };
      return GlobalTracker;
  }());
  var globalTracker = new GlobalTracker();

  var PlayerSelection = /** @class */ (function (_super) {
      __extends(PlayerSelection, _super);
      ...
      PlayerSelection.prototype.render = function () {
          var _this = this;
          var selectedPlayer = this.state.selectedPlayer;
          var players = playerService.getRegisteredPlayers();
          if (this.state.createUser) {
              return react.createElement(createNewPlayer, { onSubmit: function (userName) {
                      playerService.createPlayer(userName);
                      playerService.selectPlayer(userName);
                      _this.setState({
                          createUser: false
                      });
                      _this.props.onPlayerSelect(playerService.getSelectedPlayer());
              ...
              var selected_1 = 'selectedUser btnItem';
              var nonSelected_1 = 'btnItem nonSelectedUser';
              return (react.createElement("div", { className: "playerSelection centered md" },
                  react.createElement("div", { className: "menuHeader" }, i18n.switchPlayer),
                  react.createElement("div", { className: "btnList " },
                      players.map(function (player, i) {
                          var className = selectedPlayer.userName === player.userName ? selected_1 : nonSelected_1;
                          return (react.createElement("div", { key: i },
                              react.createElement("button", { className: className, onClick: function () {
                                  ...
                                  player.userName,
                                  " ",
                                  react.createElement("span", { className: "isActive" },
                                      " - ",
                                      i18n.selected)),
                              react.createElement("button", { className: "btnItem delete", onClick: function () {
                                      // delete the selected user?
                                      playerService.deletePlayer(player.userName);
                                      _this.setState({
                                          players: playerService.getRegisteredPlayers().length
                                      });
                                      _this.props.onPlayerDelete(player.userName);
                                  } }, i18n.del)));
                      }),
                      react.createElement("button", { className: "btnItem createPlayerBtn", onClick: function () {
                              _this.setState({
                                  createUser: true
                              });
  ...
  var MainMenu = /** @class */ (function (_super) {
      ...
      MainMenu.prototype.topMenu = function () {
          var _this = this;
          if (this.state.selection) {
              return null;
          }
          return (react.createElement("div", { className: "btnList mainMenu" },
              react.createElement("button", { className: "btnItem", onClick: function () {
                      _this.setState({ selection: 'campaign' });
                  } }, i18n.campaign),
              react.createElement("button", { className: "btnItem", onClick: function () {
                      _this.setState({ selection: 'quickStart' });
                  } }, i18n.quickStart),
              react.createElement("button", { className: "btnItem", onClick: function () {
                      _this.setState({ selection: 'help' });
                  } }, i18n.help),
              react.createElement("button", { className: "btnItem goToPlayerSelection", onClick: function () {
                      _this.setState({ selection: 'playerSelection' });
                  } }, i18n.changeActivePlayer),
              react.createElement("button", { className: "btnItem", onClick: function () {
                      _this.setState({ selection: 'about' });
                  } }, i18n.about)));
      };
      MainMenu.prototype.about = function () {
          ...
          return (react.createElement("div", { className: "about bordered centered md" }, "Created by Patrick Tolosa"));
      };
      MainMenu.prototype.help = function () {
          if (this.state.selection !== 'help') {
              return null;
          }
          return (react.createElement("div", { className: "centered md" },
              react.createElement(Help, { levelHints: null, onClick: null })));
      };
      MainMenu.prototype.levelSelection = function () {
          var _this = this;
          if (this.state.selection !== 'campaign') {
              return null;
          }
          var levelsPassed = this.props.selectedPlayer.levelsPassed;
          // Done planets are earthy
          return (react.createElement("div", { className: "campaignScreen" }, this.props.levels.map(function (level, i) {
              var levelIsDone = !!levelsPassed[+level.key];
              var lastLevelDone = i === 0 || !levelIsDone && i > 0 && levelsPassed[+_this.props.levels[i - 1].key];
              var lvlIsNextCls = lastLevelDone ? 'nextLevel' : '';
              var lvlIsDoneCls = levelIsDone ? 'levelIsDone' : '';
              return (react.createElement("div", { className: "level " + lvlIsNextCls + " " + lvlIsDoneCls, key: level.key, onClick: function () {
                      if (lastLevelDone || levelIsDone) {
                          _this.props.onLevelSelect(level, _this.props.levels);
                      }
                  } },
                  react.createElement("div", { className: "level-image" },
                      react.createElement("img", { src: levelIsDone ? player1 : player2 })),
                  react.createElement("div", { className: "level-title" }, level.key)));
          })));
      };
      MainMenu.prototype.playerSelection = function () {
          if (this.state.selection !== 'playerSelection') {
              return null;
          }
          return (react.createElement(PlayerSelection, { onPlayerSelect: this.props.onPlayerSelect, onPlayerDelete: this.props.onPlayerDelete }));
      };
      MainMenu.prototype.quickStartSelection = function () {
          var _this = this;
          if (this.state.selection !== 'quickStart') {
              return null;
          }
          return (react.createElement("div", { className: "quickStartGame" },
              react.createElement("div", { className: "row" },
                  react.createElement("div", { className: "difficultySelector col-xs-4" },
                      react.createElement("div", { className: "btnList" },
                          react.createElement("h4", { className: "title" }, "Select difficulty"),
                          difficulties.map(function (diff) {
                              return (react.createElement("button", { key: diff, className: "btnItem " + (_this.state.difficulty === diff && 'active'), onClick: function () {
                                      _this.setState({ difficulty: diff });
                                  } }, diff.toLowerCase()));
                          }))),
                  react.createElement("div", { className: "mapScaleselector col-xs-4" },
                      react.createElement("div", { className: "btnList" },
                          react.createElement("h4", { className: "title" }, i18n.selectMapSize),
                          mapScales.map(function (_a) {
                              var scale = _a.scale, title = _a.title;
                              return (react.createElement("button", { key: scale, className: "btnItem " + (_this.state.mapScale === scale && 'active'), onClick: function () {
                                      _this.setState({ mapScale: scale });
                                  } }, title.toLowerCase()));
                          }))),
                  react.createElement("div", { className: "col-xs-4" },
                      react.createElement("div", { className: "btnList" },
                          react.createElement("h4", { className: "title" }, i18n.start),
                          react.createElement("div", { className: "startGame", onClick: function () {
                                  _this.props.onQuickStart(__assign({}, _this.state));
                              } },
                              react.createElement("img", { src: player1 })))))));
      };
      MainMenu.prototype.backButton = function () {
          var _this = this;
          if (!this.state.selection) {
              return null;
          }
          return (react.createElement("button", { className: "pull-left btnBack", onClick: function () {
                  _this.setState({ selection: false });
              }, dangerouslySetInnerHTML: { __html: i18n.back } }));
      };
      MainMenu.prototype.render = function () {
          return (react.createElement("div", null,
              this.backButton(),
              react.createElement("div", { className: "" }, "" + i18n.welcome + version),
  ...
  var MainMenuBtn = /** @class */ (function (_super) {
      ...
      MainMenuBtn.prototype.render = function () {
          return (react.createElement("button", { onClick: this.props.onClick, className: "inGameBtn", type: "button" },
              react.createElement("span", { className: "" }, i18n.menu)));
      };
      return MainMenuBtn;
  }(react.Component));

  var ShowHelpBtn = /** @class */ (function (_super) {
      __extends(ShowHelpBtn, _super);
      function ShowHelpBtn() {
          return _super !== null && _super.apply(this, arguments) || this;
      }
      ShowHelpBtn.prototype.render = function () {
          return (react.createElement("button", { onClick: this.props.onClick, className: "inGameBtn", type: "button" },
              react.createElement("span", { className: "" }, i18n.inGameHelp)));
      };
      return ShowHelpBtn;
  }(react.Component));
  ...
  var Minimap = /** @class */ (function (_super) {
      ...
      Minimap.prototype.isHidden = function () {
      ...
      Minimap.prototype.render = function () {
          ...
          if (this.state.isOpen) {
              return (react.createElement("div", { className: "minimapSection " + cls },
                  react.createElement("button", { className: "contractMinimap", onClick: function () {
              ...
              return (react.createElement("div", { className: "minimapSection minimized " + cls },
  ...
  var MainView = /** @class */ (function (_super) {
      ...
      MainView.prototype.componentWillReceiveProps = function (props) {
          var newWidthToHeight = props.newWidthToHeight, widthToHeight = props.widthToHeight, newWidth = props.newWidth, newHeight = props.newHeight;
          /* istanbul ignore next */
          if (this.el) {
      ...
      MainView.prototype.renderLevelHints = function () {
          var _this = this;
          if (this.state.showLevelHints) {
              return (react.createElement("div", { className: "hintsContainer bordered" },
                  react.createElement("ul", null, this.props.levelHints.map(function (item, i) {
                  ...
                  react.createElement("button", { className: "btnItem", onClick: function () {
                          ...
                          _this.props.onLevelHintsApproved();
                      } }, "Got it")));
          }
          else {
              return null;
      ...
      MainView.prototype.render = function () {
          var _this = this;
          return (react.createElement("div", { className: "canvasContainer", ref: function (el) {
                  if (el) {
                      _this.el = el;
                  }
              } },
  ...
  var neutral = "./neutral.png";

  var shield = "./shield.png";
  ...
  function renderMap(entity, canvasAPI) {
      var _a = entity[POSITION], x = _a.x, y = _a.y, radius = _a.radius, angle = _a.angle;
      var lineWidth = 1;
      if (entity.hasComponents(OWNER_COMPONENT)) {
          gameConfig[COLORS][entity[OWNER_COMPONENT].player];
      }
      if (isSelected(entity)) {
          lineWidth = gameConfig[SELECT_WIDTH];
      }
      var drawFighterCount = function () {
      };
      // TODO - Why are we only rendering on the canvas if we have a Sprite?
      if (entity.hasComponents(SPRITE)) {
          entity[UI_COMP].sections.forEach(function (section) {
          ...
          entity[SPRITE].images.forEach(function (imageToRender, i) {
              // REFACTOR this is ugly, create a fn that gets all this from the entity.
              var data = imageBuffer[imageToRender.name][entity[OWNER_COMPONENT].player];
              if (!data) {
                  return;
              }
              var _a = data.spriteArgs, cropStartX = _a[0], cropStartY = _a[1], cropSizeX = _a[2], cropSizeY = _a[3];
              var image = data.img;
  ...
  function renderMiniMap(entity, canvasAPI) {
      var _a = entity[POSITION], x = _a.x, y = _a.y, radius = _a.radius; _a.angle;
      var color;
      var lineWidth = 1;
      if (entity.hasComponents(OWNER_COMPONENT)) {
  ...
  function renderSystem(systemArguments, mapAPI, miniMapAPI, selectedBox) {
      mapAPI.clear();
      miniMapAPI.clear();
      var entsToDraw = systemArguments.Entity.getByComps([UI_COMP]);
      /* istanbul ignore else  */
      if (mapAPI && miniMapAPI) {
          var _a = mapAPI.getPan(), panX_1 = _a.panX, panY_1 = _a.panY;
          var _b = systemArguments.viewSize, viewWidth_1 = _b.viewWidth, viewHeight_1 = _b.viewHeight;
          var loopHandler = function (entity) {
              var _a = entity[POSITION], x = _a.x, y = _a.y, radius = _a.radius;
              var entWidth = radius * 2;
              var entHeight = radius * 2;
              var xOutOfBound = x + entWidth < -panX_1 || x - entWidth > -panX_1 + viewWidth_1;
              var yOutOfBound = y + entHeight < -panY_1 || y - entHeight > -panY_1 + viewHeight_1;
  ...
  var levelsData = {
  	...
  	buffer: 2,
  	hints: [
  		"Welcome to Planet Escape, your task is to completely conquer the sector!",
  		"Tap on a friendly planet to select it",
  		"Selected planets have a green border",
  		"Tap on an Enemy planet to attack it",
  		"Double tap on a friendly planet to select all planets",
  		"Tap any where in space to cancel the current selection",
  		"Planets are conquered when they're out of defending fighters"
  	],
  	planetsInMap: 0,
  	planets: [
  		{
  	...
  	mapScale: 1,
  	hints: [
  		"This sector is so large, you have a minimap to help you navigate around!",
  		"Tap anywhere on the minimap to quickly move around the sector"
  	],
  	buffer: 2,
  	planetsInMap: 0,
  	planets: [
  ...
  var levels = [];
  Object.keys(levelsData).forEach(function (levelKey) {
      var levelData = __assign({}, levelsData[levelKey]);
      levelData.key = levelKey;
      if (levelData.order >= 0) {
          levels.push(levelData);
      }
  });
  levels.sort(function (aLevel, bLevel) {
      return aLevel.order - bLevel.order;
  });

  var CookiePolicy = /** @class */ (function (_super) {
      __extends(CookiePolicy, _super);
      function CookiePolicy(props) {
          var _this = _super.call(this, props) || this;
          var cookieAccepted;
          _this.cookieName = 'PE_AC';
          _this.handleClick = _this.handleClick.bind(_this);
          if (document.cookie && document.cookie.indexOf) {
              cookieAccepted = document.cookie.indexOf(_this.cookieName) >= 0;
          }
          _this.state = {
      ...
      CookiePolicy.prototype.handleClick = function () {
      ...
      CookiePolicy.prototype.render = function () {
          if (!this.state.cookieAccepted) {
              return (react.createElement("div", { className: "cookiePolicy" },
                  react.createElement("div", null, "This site uses cookies for the following reasons:"),
                  react.createElement("div", null, "Analytics - We track how players interact with the game"),
                  react.createElement("div", null, "Functional - We store your in-game progress on your device"),
                  react.createElement("div", null, "By playing you agree to allow the website to collect this information"),
                  react.createElement("div", null,
                      react.createElement("a", { target: "_blank", href: "https://cookiesandyou.com/" }, "Learn more")),
                  react.createElement("button", { className: "btnItem", onClick: this.handleClick }, "Got it")));
          }
          else {
              return null;
          }
  ...
  var App = /** @class */ (function (_super) {
      ...
      function App(props) {
          ...
          _this.handlePlayerSelect = _this.handlePlayerSelect.bind(_this);
          _this.handlePlayerDelete = _this.handlePlayerDelete.bind(_this);
          _this.levels = levels;
          /* istanbul ignore next */
          window.stressTest = function () {
              gameConfig[FIGHTER_BUILD_RATE] = 10;
              // @ts-ignore TODO add types for gameConfig;
              _this.startGame(gameConfig[MAP_SIZE][LARGE], gameConfig[DIFFICULTY][STRESS_TEST]).then(function (game) {
                  _this.game = game;
              });
          };
          return _this;
      ...
      App.prototype.componentDidMount = function () {
          ...
          var resizeGame = function () {
              var widthToHeight = 960 / 540; // TODO is this magical ?
          ...
          setInterval(function () {
              if (_this.state.newHeight !== window.innerHeight) {
                  resizeGame();
              }
          }, 500);
          resizeGame();
      };
      App.prototype.startGame = function (levelData, difficulty) {
          var _this = this;
          levelData.width = 1920 * levelData.mapScale;
          levelData.height = 1080 * levelData.mapScale;
          return new Promise(function (resolve, reject) {
              var gameCanvas = new build_3({
                  ...
                  onViewMapMove: function (dataObj) {
                      _this.selectedBox = dataObj.selectedBox;
                  },
                  onViewMapClick: function (dataObj) {
              ...
              setTimeout(function () {
                  var game = new GameLoop({
                      notificationSystem: _this.updateGameState,
                      levelData: levelData,
                      viewSize: {
                          viewHeight: gameConfig[MAIN_VIEW_SIZE_Y],
                          viewWidth: gameConfig[MAIN_VIEW_SIZE_X],
                      ...
                      renderSystem: _this.renderOnCanvas
                  });
                  if (levelData.hints) {
                      setTimeout(function () {
                  ...
                  _this.setState({
                      gameCount: _this.state.gameCount + 1,
                      isMenuOpen: false,
                      gamePaused: false,
                      gameEnded: false,
                      gameWon: null,
      ...
      App.prototype.renderOnCanvas = function (systemArguments) {
          /* istanbul ignore else  */
          if (this.state.viewMapCanvasAPI) {
              renderSystem(systemArguments, this.state.viewMapCanvasAPI, this.state.miniMapCanvasAPI, this.selectedBox);
          }
      };
      // TODO if this is a system, why is it in the UI layer?
      // this is "just like any other system", but it sits at the App level..
      App.prototype.updateGameState = function (systemArguments) {
          var gameEnt = systemArguments.Entity.getByComps([GAME_STATE])[0];
          var gameTracker = systemArguments.gameTracker;
          if (gameEnt) {
              var gameWon = gameEnt[GAME_STATE].status === GAME_WON;
              var gameLost = gameEnt[GAME_STATE].status === GAME_LOST;
              if (gameWon) {
                  // selectedPlayer
      ...
      App.prototype.getGameEndModal = function () {
          var _this = this;
          var gameWon = this.state.gameWon;
          var nextLevel;
          var currentLevelIdx = this.levels.indexOf(this.state.currentLevel);
          nextLevel = this.levels[currentLevelIdx + 1];
          if (gameWon !== null) {
              return (react.createElement(Modal, { gameWon: gameWon, text: gameWon ? i18n.gameWon : i18n.gameLost, nextLevel: nextLevel, onRestart: function () {
                      _this.startGame(_this.state.currentLevel, _this.difficulty).then(function (game) {
                          _this.game = game;
                      });
                  }, onNextLevel: function () {
                      _this.startGame(nextLevel, _this.difficulty).then(function (game) {
                          _this.game = game;
                      });
                  }, backToMainMenu: function () {
                      _this.setState({ gamePaused: false });
                      _this.stopGame();
                  } },
                  react.createElement("div", { className: "gameStats" },
                      react.createElement("h4", null, i18n.stats),
                      Object.keys(this.state.gameReport).map(function (key) {
                          return (react.createElement("div", { key: key },
                              react.createElement("span", { className: "key" }, i18n[key]),
                              react.createElement("span", { className: "value" }, _this.state.gameReport[key].count)));
                      }))));
          }
          else {
              return null;
      ...
      App.prototype.mainMenu = function () {
          var _this = this;
          return (react.createElement(MainMenu, { selectedPlayer: this.state.selectedPlayer, onPlayerSelect: this.handlePlayerSelect, onPlayerDelete: this.handlePlayerDelete, levels: levels, onLevelSelect: function (level, levels) {
                  _this.levels = levels; // TODO why do we need it here?
                  _this.difficulty = gameConfig[DIFFICULTY].EASY;
                  _this.startGame(level, _this.difficulty).then(function (game) {
                      _this.game = game;
                  });
              }, onQuickStart: function (menuSelection) {
                  var randLevel = {
                      height: null,
                      hints: [],
                      order: 0,
                  ...
                  _this.difficulty = gameConfig[DIFFICULTY][menuSelection.difficulty];
                  _this.startGame(randLevel, _this.difficulty).then(function (game) {
                      _this.game = game;
                  });
              } }));
      };
       ...
       * @return {*}
       */
      App.prototype.pauseMenu = function () {
          var _this = this;
          if (!this.state.gamePaused) {
              return null;
          }
          else {
              return (react.createElement("div", { className: "centered md gamePausedMenu" },
                  react.createElement("div", { className: "menuHeader" }, "Game paused"),
                  react.createElement("div", { className: "btnList" },
                      react.createElement("button", { className: "btnItem", onClick: function () {
                              _this.setState({ gamePaused: false });
                              _this.resumeGame();
      ...
      App.prototype.showHelp = function () {
          ...
          if (!this.state.showHelp) {
              ...
              return (react.createElement(Help, { levelHints: this.state.currentLevel.hints, onClick: function () {
                      _this.setState({
                          gamePaused: false,
                          showHelp: false
                      });
      ...
      App.prototype.handlePlayerSelect = function (selectedPlayer) {
          this.setState({
              selectedPlayer: selectedPlayer
          });
      };
      App.prototype.handlePlayerDelete = function () {
          this.setState({
              selectedPlayer: playerService.getSelectedPlayer()
          });
      };
      App.prototype.render = function () {
          ...
          if (!this.state.selectedPlayer || this.state.showPlayerManagement) {
              content = (react.createElement(PlayerSelection, { onPlayerSelect: this.handlePlayerSelect, onPlayerDelete: this.handlePlayerDelete }));
          }
              ...
              content = (react.createElement("div", null,
                  react.createElement("div", { className: "inGameBtns" },
                      !this.state.showLevelHints && react.createElement(ShowHelpBtn, { onClick: function () {
                              _this.pauseGame();
                              // show the hints?
                              _this.setState({
                                  showHelp: true
                      ...
                      !this.state.showLevelHints && react.createElement(MainMenuBtn, { onClick: function () {
                              _this.pauseGame();
                          } })),
                  react.createElement(Minimap, { canvasReactElement: this.state.minimap, currentLevelData: this.state.currentLevel }),
                  react.createElement("div", { className: "container-fluid app" },
                      react.createElement("div", { className: "" },
                          react.createElement(MainView, { levelHints: this.state.levelHints, showLevelHints: this.state.showLevelHints, onLevelHintsApproved: function () {
                                  _this.setState({
                                      showLevelHints: false
                                  });
                                  _this.resumeGame();
                              }, widthToHeight: this.state.widthToHeight, newWidthToHeight: this.state.newWidthToHeight, newWidth: this.state.newWidth, newHeight: this.state.newHeight, viewMapCanvasAPI: this.state.viewMapCanvasAPI, canvasElm: this.state.map })))));
          }
          return (react.createElement("div", { className: "page" },
              react.createElement("div", { className: "pageContent" }, content),
              react.createElement(CookiePolicy, null)));
      };
      return App;
  }(react.Component));

  var mainMenuBackground = "./background.jpg";

  var APP = 'APP';
  var LVL = 'LVL';
  function event(_a) {
      var eventCategory = _a.eventCategory, eventAction = _a.eventAction, _b = _a.eventLabel, eventLabel = _b === void 0 ? null : _b, _c = _a.eventValue, eventValue = _c === void 0 ? null : _c;
      window.ga('send', {
          hitType: 'event',
  ...
  var GoogleTracking = /** @class */ (function () {
      function GoogleTracking() {
      }
      GoogleTracking.prototype.track = function (eventName, payload) {
  ...
  var googleTracking = new GoogleTracking();
  ...
  loadImages([mainMenuBackground, neutral, player1, player2, fighter], function () {
